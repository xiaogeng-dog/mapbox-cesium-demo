    ...
    <div class="main-container">
      ...
      <div class="col3">
        ...
        >
          ...
          <!-- 这里用cesium会出现entity重复id的报错,因为管线的起点和终点都是同一个id,暂时没想到解决方法先注了 -->
  ...
  methods: {
    ...
    getMapPoint() {
      ...
      this.markerData.pipenetLineList.forEach((item) => {
        ...
        startPoint.longitude = item.startLnt.split(',')[0]
        startPoint.latitude = item.startLnt.split(',')[1]
        ...
        endPoint.longitude = item.startLnt.split(',')[0]
        endPoint.latitude = item.startLnt.split(',')[1]
    ...
    openInfowindow(coord, extData) {
      ...
      var content = this.renderMarkerContent(data)
  ...
  watch: {
    treeSearch(val) {
      if (val === '') {
        ...
        this.mapData = this.originalMarker
        this.initMapData()
      } else {
