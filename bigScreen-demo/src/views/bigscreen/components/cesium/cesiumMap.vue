...
export default {
  ...
  methods: {
    // 初始化
    init() {
      Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJmZWVjOWRlMy1iOTRhLTQxNDktOGM3Ny0yMTRjZTFkMDg5MWUiLCJpZCI6Mjk1MjUsInNjb3BlcyI6WyJhc3IiLCJnYyJdLCJpYXQiOjE1OTIyOTY5Mjh9.nVxUnQ6d-g8pp2hB3gfL77auBxQLybpuSKRm-0u_CVE'
